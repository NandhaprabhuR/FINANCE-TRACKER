...
import 'package:ft/screen/home.dart' as home_screen;
import 'package:ft/screen/signup.dart';
...
class AIAssistantScreen extends StatefulWidget {
  final Gemini gemini; // Pass the initialized Gemini instance
...
class _AIAssistantScreenState extends State<AIAssistantScreen> {
  ...
  void _generateContent() async {
    ...
    try {
      // Add a finance-specific prefix to the prompt
  ...
  String _formatResponse(String rawResponse) {
    ...
    // Process the lines to add proper formatting
            ...
            child: SingleChildScrollView(
              child: Text(
                ...
                style: GoogleFonts.inter(
                  fontSize: 16,
                  height: 1.5, // Improve readability with line spacing
                ),
              ),
            ),
          ),
...
void main() async {
  ...
  final gemini = Gemini.instance; // Access the initialized instance
  ...
  runApp(
    MultiProvider(
      ...
      child: MyApp(gemini: gemini), // Pass the Gemini instance to the app
    ),
  );
}
                    ...
                    try {
                      ...
                      runApp(
                        MultiProvider(
                          ...
                          child: MyApp(gemini: Gemini.instance), // Use the initialized instance
                        ),
                      );
                    } catch (e) {
                      debugPrint("Firebase initialization failed: $e");
...
class MyApp extends StatelessWidget {
  final Gemini gemini; // Receive the Gemini instance
                ...
                return FutureBuilder<bool>(
                  future: () async {
                    ...
                    try {
                      ...
                      return true; // Proceed to MainScreen even if data fetch fails
                    }
                  }(),
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
...
class _MainScreenState extends State<MainScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _screens = [
      ...
      AIAssistantScreen(gemini: widget.gemini), // Pass the Gemini instance
    ];
